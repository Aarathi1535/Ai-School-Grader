...
ANSWER_KEY: Dict[str, QuestionSpec] = {
    ...
    # Q2(iv) Explain terms (all full marks if non-empty)
    "2(iv).1": QuestionSpec(
        id="2(iv).1",
        text="Evaporation",
        q_type="short_def",
    ...
    "4.1.e": QuestionSpec(id="4.1.e", text="Saw dust and water",               q_type="short_direct", max_marks=1.0, correct_value="filtration"),

    # Q4.2 filtration diagram
    "4.2.a": QuestionSpec(
        id="4.2.a",
        text="Identify A and B",
        q_type="short_direct",
        max_marks=2.0,
    ...
    "4.2.c": QuestionSpec(
        id="4.2.c",
        text="Why salt + water not separated by filtration?",
        q_type="reason",
        max_marks=1.0,
    ),
    "4.2.d": QuestionSpec(
    ...
    # Q5.1 flow chart
    "5.1.1": QuestionSpec(id="5.1.1", text="Flowchart blank 1", q_type="flowchart", max_marks=1.0, correct_value="mixture"),
    "5.1.2": QuestionSpec(id="5.1.2", text="Flowchart blank 2", q_type="flowchart", max_marks=1.0, correct_value="compounds"),
    "5.1.3": QuestionSpec(id="5.1.3", text="Flowchart blank 3", q_type="flowchart", max_marks=1.0, correct_value="heterogeneous"),
    "5.1.4": QuestionSpec(id="5.1.4", text="Flowchart blank 4", q_type="flowchart", max_marks=1.0, correct_value="non-metals"),
    "5.1.5": QuestionSpec(id="5.1.5", text="Flowchart blank 5", q_type="flowchart", max_marks=1.0, correct_value="metalloids"),

    # Q5.2 one-word
    "5.2.a": QuestionSpec(id="5.2.a", text="Mixture where particles seen easily", q_type="short_direct", max_marks=1.0, correct_value="heterogeneous mixture"),
    "5.2.b": QuestionSpec(id="5.2.b", text="Molecule with three atoms",          q_type="short_direct", max_marks=1.0, correct_value="triatomic"),
    "5.2.c": QuestionSpec(id="5.2.c", text="Apparatus for immiscible liquids",   q_type="short_direct", max_marks=1.0, correct_value="separating funnel"),
    "5.2.d": QuestionSpec(id="5.2.d", text="Liquid to solid at fixed temp",      q_type="short_direct", max_marks=1.0, correct_value="freezing"),
    "5.2.e": QuestionSpec(id="5.2.e", text="Change over a long period",          q_type="short_direct", max_marks=1.0, correct_value="slow change"),

    # Q6.1
    "6.1.a": QuestionSpec(id="6.1.a", text="Nature of iron + sulphur mixture", q_type="short_direct", max_marks=1.0, correct_value="solid solid heterogeneous"),
    "6.1.b": QuestionSpec(id="6.1.b", text="Which component attracted by magnet", q_type="short_direct", max_marks=1.0, correct_value="iron"),
    "6.1.c": QuestionSpec(id="6.1.c", text="Behaviour after compound forms", q_type="short_direct", max_marks=1.0, correct_value="both iron and sulphur are not attracted to the magnet"),

    # Q6.2
    "6.2.a": QuestionSpec(id="6.2.a", text="Apparatus a", q_type="short_direct", max_marks=1.0, correct_value="conical flask"),
    "6.2.b": QuestionSpec(id="6.2.b", text="Apparatus b", q_type="short_direct", max_marks=1.0, correct_value="funnel"),
    "6.2.c": QuestionSpec(id="6.2.c", text="Apparatus c", q_type="short_direct", max_marks=1.0, correct_value="separating funnel"),
    "6.2.d": QuestionSpec(id="6.2.d", text="Apparatus d", q_type="short_direct", max_marks=1.0, correct_value="watch glass"),
    "6.2.e": QuestionSpec(id="6.2.e", text="Apparatus e", q_type="short_direct", max_marks=1.0, correct_value="round bottomed flask"),
    "6.2.f": QuestionSpec(id="6.2.f", text="Apparatus f", q_type="short_direct", max_marks=1.0, correct_value="test tube holder"),
}
